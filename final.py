# final_controller_v2.py
# This version includes a fix for the serial connection on some systems.
...
# --- SETUP ---
print("Starting AI Ghost Hand Controller V2...")

# 1. Setup Serial Connection to Arduino
try:
    # THE FIX: Added `dsrdtr=False` to prevent the port from being immediately reset in a way that can cause issues.
...
while cap.isOpened():
    ...
    cv2.imshow('AI Ghost Hand - Controller V2', image)
