# final_controller_v11.py
# This version implements the new control scheme:
# - Left Hand (OPEN_PALM/FIST) for Pump.
# - Right Hand (OPEN_PALM/FIST) for Lamp.
...
# --- SETUP ---
print("Starting AI Ghost Hand Controller V11 (New Control Scheme)...")
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_idx, hand_landmarks in enumerate(results.multi_hand_landmarks):
            ...
            try:
                ...
                # Gesture Logic (Only OPEN_PALM and FIST)
    ...
    cv2.imshow('AI Ghost Hand - Controller V11', image)
